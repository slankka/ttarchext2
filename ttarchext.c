...
/*
    ...
    #error "ttarchext must be compiled as 64bit to load the Oodle DLL."
#endif
*/
...
typedef struct {
    int     old_mode;   // use 2 for old_mode+encryption
    u8      *key;
    u8      *name;
    int     extension;
...
gamekeys_t  gamekeys[] = {
    ...
    { 1, "\x34\x24\x6C\x33\x43\x72\x6C\x75\x64\x32\x65\x53\x57\x69\x45\x32\x4F\x61\x63\x39\x6C\x75\x74\x78\x6C\x37\x32\x52\x2D\x2A\x38\x49\x31\x71\x4F\x34\x6F\x61\x6A\x6C\x5F\x24\x65\x23\x69\x61\x63\x70\x34\x2A\x75\x46\x6C\x65\x30", "CSI 3 - Dimensions of Murder / Bone demo", EXT_TTARCH, -1 },
    ...
    { 0, "\x81\xca\xa1\xa1\x85\xda\x64\x73\xa2\xae\xd6\xd8\x9f\xc6\xc1\x88\x99\x5a\x6f\xd8\xb1\xe2\x97\xdd\x96\x51\x9f\x97\x9a\xe0\xce\x95\xcd\x76\x62\x7f\xa3\xc4\xad\xd9\xd6\xe2\xa9\x9c\x67\x74\xb3\xe3\xb2\xc4\x94\x64\xa0\xa2\x81", "Batman: The Telltale Series", EXT_TTARCH2, -1 },
    { 0, "\x96\xca\x99\x9f\x8d\xda\x9a\x87\xd7\xcd\xd9\x97\x62\x95\xaa\xb8\xd5\x95\x96\xe5\xa4\xb9\x9b\xd0\xc9\x54\x9f\x85\x90\xcd\xcd\x9f\xc8\xb3\x99\x93\xc6\xc4\x9d\x9f\xa5\xa4\xcf\xcd\xa3\x9d\xbb\xdd\xac\xa7\x8b\x94\xd4\xa5\x6f", "The Walking Dead: A New Frontier", EXT_TTARCH2, -1 },
    { 0, "\x86\xDE\x8E\xA6\x88\xD5\x94\xB1\xE5\x9D\xA5\x94\x79\xDA\xB4\xC9\xCD\x93\x8E\xE5\xB0\xA6\x66\x9F\xAC\x96\xD0\xC7\x9D\xD5\xC2\xA2\xD2\x76\x62\x7F\xA8\xD8\x9A\xDE\xD9\xDD\xD9\xDA\xAA\x63\x82\x9F\x8C\xD8\x87\xA5\xD4\xDB\xA0", "Marvel's Guardians of the Galaxy", EXT_TTARCH2, -1 },
    { 0, "\x8c\xd2\x9b\x99\x87\xde\x94\xa9\xe6\x9e\xa5\x94\x7f\xce\xc1\xbc\xcc\x9c\x8e\xdd\xb1\xa7\x66\x9f\xb2\x8a\xdd\xba\x9c\xde\xc2\x9a\xd3\x77\x62\x7f\xae\xcc\xa7\xd1\xd8\xe6\xd9\xd2\xab\x64\x82\x9f\x92\xcc\x94\x98\xd3\xe4\xa0", "Minecraft: Story Mode - Season Two", EXT_TTARCH2, -1 },
    { 0, "\x81\xCA\xA1\xA1\x85\xDA\x65\x73\xA2\xAE\xD6\xD8\x9F\xC6\xC1\x89\x99\x5A\x6F\xD8\xB1\xE2\x97\xDD\x97\x51\x9F\x97\x9A\xE0\xCE\x95\xCD\x77\x62\x7F\xA3\xC4\xAD\xD9\xD6\xE2\xAA\x9C\x67\x74\xB3\xE3\xB2\xC4\x94\x65\xA0\xA2\x81", "Batman: The Enemy Within", EXT_TTARCH2, -1 },
    { 2, "\x82\xa3\x89\x88\x89\xd8\x9f\xb7\xd3\xd8\xda\xc0\x82\xd7\xc2\xc1\xce\x8d\xa1\xea\x99\xb7\xa5\xdd\xca\x52\xe5\x87\x69\xc8\xa4\x6e\xbb\x99\x97\xbb\xcd\xd7\x9a\xd8\xda\xd0\xc8\xde\xa6\x9c\xb7\xd2\xb9\xd6\x82\x75\xdf\xe0\xa4", "Bone: Out From Boneville 2.0", EXT_TTARCH, -1 },
    { 2, "\x82\xa3\x89\x88\x89\xd8\x9f\xb7\xd3\xd8\xda\xc0\x82\xd7\xc2\xc1\xce\x8d\xa1\xea\x99\xb7\xa5\xdd\xca\x53\xe5\x87\x69\xc8\xa4\x6e\xbb\x99\x97\xbb\xcd\xd7\x9a\xd8\xda\xd0\xc8\xde\xa6\x9c\xb7\xd2\xb9\xd6\x82\x75\xdf\xe0\xa4", "Bone: The Great Cow Race 2.0", EXT_TTARCH, -1 },
    { 0, "\x96\xCA\x99\x9F\x8D\xDA\x9A\x87\xD7\xCD\xD9\xBB\x93\xD1\xBE\xC0\xD7\x91\x71\xDC\x9E\xD9\x8D\xD0\xD1\x8C\xD8\xC3\xA0\xB0\xC6\x95\xC3\x9C\x93\xBB\xCC\xCC\xA7\xD3\xB9\xD9\xD9\xD0\x8E\x93\xBE\xDA\xAE\xD1\x8D\x77\xD5\xD3\xA3", "The Walking Dead: The Telltale Definitive Series", EXT_TTARCH2, -1 },
    { 0, NULL, NULL, -1, -1 }
};
...
u64 ttarch_import(FILE *fdo, u8 *fname, u8 **out_buff);
...
i64 _oodle_decompress(u8 *in, i64 insz, u8 *out, i64 outsz);
i64 _z_decompress(u8 *in, i64 insz, u8 *out, i64 outsz);
i64 (*do_decompress)(u8 *in, i64 insz, u8 *out, i64 outsz) = _z_decompress;
...
int oodle_init(void);
// Oodle function pointer from oodle.c
extern int (__stdcall *OodleLZ_Decompress)(unsigned char *in, int insz, unsigned char *out, int outsz, int a, int b, int c, void *d, void *e, void *f, void *g, void *h, void *i, int j);
...
int main(int argc, char *argv[]) {
    ...
    setbuf(stdout, NULL); // Disable buffering to see all output before crash
    ...
    if(argc < 4) {
        ...
        printf("\n"
            ...
            "  ttarchext.exe -b -z -L -V 7 55 c:\\output.ttarch2 c:\\input_folder\n"
            "\n"
    ...
    for(i = 1; i < argc; i++) {
        ...
        switch(argv[i][1]) {
            ...
            case 'O': force_old_mode++;                         break;  // -O is old_mode 1, -O -O is old_mode 2
    ...
    if(rebuild) {
        ...
        printf("- use_oodle flag: %d\n", use_oodle);
        if(keep_lua_ext) {
            printf("- keep_lua_extension: %d (keeping .lua instead of .lenc)\n", keep_lua_ext);
        }
    ...
    if(force_old_mode) old_mode = force_old_mode;
        ...
        if(IS_LUA(buff) || (encrypt && (gamenum >= 58))) {
            if(gamenum >= 58) {
                ...
                *size += 4;
                ...
                // For gamenum < 55, check if we're rebuilding
                // If the file is already decrypted (\x1bLua), don't encrypt it again
                // because the original archive might not have encrypted Lua files
                if(encrypt && IS_LUA(buff)) {
                    // File is already decrypted (\x1bLua format)
                    // Skip encryption for rebuilding
                    printf("- Warning: Lua file is already decrypted, skipping encryption for gamenum %d\n", gamenum);
                    return -1;  // Return -1 to skip encryption
                }
...
u64 ttarch_import(FILE *fdo, u8 *fname, u8 **out_buff) {
    ...
    // If caller wants the processed data, give it to them
...
u8 *import_filename(u8 *fname) {
    ...
    if(ext && !stricmp(ext, ".lua")) {
        if(keep_lua_ext) {
            // Keep original .lua extension (don't convert to .lenc)
            // Use -L option to enable this
            return fname;
        }
...
u32 rebuild_it(u8 *output_name, FILE *fdo) {
    ...
    // For Oodle compression, we need to process files differently
    // We'll collect processed file data into memory first
    u8 **file_data = NULL;
    if(use_oodle && ext && !stricmp(ext, ".ttarch2")) {
        printf("- pre-processing files for Oodle compression...\n");
        file_data = calloc(tot, sizeof(u8*));
        for(i = 0; i < tot; i++) {
            u8 *processed_data = NULL;
            // ttarch_import now returns the processed data in processed_data
            files[i].size = ttarch_import(NULL, files[i].name, &processed_data);
            file_data[i] = processed_data;  // Already allocated by ttarch_import
        }
    } else {
        for(i = 0; i < tot; i++) {
            files[i].size = ttarch_import(NULL, files[i].name, NULL);
        }
    }
    ...
    if(ext && !stricmp(ext, ".ttarch2")) {
        ...
        if(file_data) {
            printf("- Warning: file_data array is out of sync after sorting, reading files directly...\n");
            // Free all pre-allocated data
            for(i = 0; i < tot; i++) {
                if(file_data[i]) free(file_data[i]);
            }
            free(file_data);
            file_data = NULL;  // This will trigger direct file reading in the write loop
        }
        ...
        if(use_oodle) {
            printf("- entering Oodle compression mode\n");
            // zCTT format: ALL data after the offset table must be compressed
            // Structure: zCTT(4) + total_size(8) + chunk_size(4) + chunk_count(4) + offset_table(8*(N+1)) + COMPRESSED_DATA
            // The compressed data contains: 3ATT(4) + names_size(4) + file_count(4) + info_table + names_table + file_data
            ...
            u64 total_uncompressed_size = header_data_size + data_size;
            u64 chunk_count = (total_uncompressed_size + 0x10000 - 1) / 0x10000;
            ...
            printf("- allocated %u bytes for uncompressed data\n", (u32)total_uncompressed_size);
            ...
            if(gamenum >= 58 || force_4att) {
                ...
                write_ptr += putxx(write_ptr, 2,          4);
            }
            write_ptr += putxx(write_ptr, names_size, 4);
            write_ptr += putxx(write_ptr, tot,        4);
            ...
            memcpy(write_ptr, info_table, info_size);
            write_ptr += info_size;

            // Write names_table
            memcpy(write_ptr, names_table, names_size);
            write_ptr += names_size;

            // Now write all file data (already processed above)
            printf("- writing %d files to uncompressed buffer...\n", tot);
            for(i = 0; i < tot; i++) {
                if((i % 10) == 0) printf("  writing file %d (size: %u, name=%s)...\n", i, (u32)files[i].size, files[i].name);
                if(files[i].size == 0) {
                    printf("  file %d has size 0, skipping...\n", i);
                    continue;  // Skip empty files
                }
                // Check if we have pre-processed data
                if(file_data && file_data[i]) {
                    // Valid data found
                    memcpy(write_ptr, file_data[i], files[i].size);
                    write_ptr += files[i].size;
                    free(file_data[i]);  // Free the pre-processed data
                    file_data[i] = NULL;  // Mark as freed
                } else if(file_data) {
                    // file_data exists but this entry is NULL - this is an error!
                    printf("  ERROR: file_data[%d] is NULL (name=%s, size=%u)\n", i, files[i].name, (u32)files[i].size);
                    exit(1);
                } else {
                    // No pre-processed data, read file directly
                    printf("  reading file %s directly (%u bytes)...\n", files[i].name, (u32)files[i].size);
                    FILE *fdi = fopen(files[i].name, "rb");
                    if(!fdi) {
                        printf("  ERROR: Cannot open file %s\n", files[i].name);
                        exit(1);
                    }
                    myfr(fdi, write_ptr, files[i].size);
                    write_ptr += files[i].size;
                    fclose(fdi);
                }
            }
            // file_data already freed above
            printf("- file data written (buffer size: %u bytes), starting compression...\n", (u32)(write_ptr - all_data));
            fflush(stdout);  // Force flush output

            // Write zCTT header (lowercase z for Oodle compression)
            // Standard ZCTT format: magic(4) + compression_type(4) + chunk_size(4) + chunk_count(4) + offset_table
            // compression_type: 1 = Oodle
            printf("- writing zCTT header...\n");
            fputxx(fdo, 0x5454437a, 4);           // zCTT (note: lowercase z)
            fputxx(fdo, 1, 4);                    // compression type: 1 = Oodle
            fputxx(fdo, 0x10000, 4);              // chunk_size (64KB)
            fputxx(fdo, chunk_count, 4);           // chunk_count
            printf("- zCTT header written, offset=%u\n", (u32)ftell(fdo));

            // Reserve space for offset table (8 bytes per chunk, plus one for end offset)
            u64 chunk_table_pos = ftell(fdo);
            u64 *chunk_offsets = calloc(chunk_count + 1, sizeof(u64));
            if(!chunk_offsets) std_err();
            chunk_offsets[0] = chunk_table_pos + offset_table_size;
            for(i = 0; i <= chunk_count; i++) {
                fputxx(fdo, 0, 8);
            }
            printf("- offset table reserved, table_pos=%u\n", (u32)chunk_table_pos);

            // Initialize Oodle
            printf("- initializing Oodle for compression...\n");
            if(oodle_init() < 0) {
                printf("\nError: Failed to initialize Oodle DLL\n");
                exit(1);
            }
            printf("- Oodle initialized\n");
            // Skip verbose output to avoid potential issues
            // printf("- Total files to compress: %d\n", tot);
            // printf("- Total uncompressed size: %u bytes\n", (u32)total_uncompressed_size);
            // printf("- Number of chunks: %u\n", (u32)chunk_count);

            // Compress and write data in chunks
            //printf("- compressing %u bytes with Oodle (%u chunks)...\n", (u32)total_uncompressed_size, (u32)chunk_count);
            u8 *compressed_buffer = malloc(0x10000 * 2);
            if(!compressed_buffer) {
                printf("\nError: Cannot allocate compression buffer\n");
                exit(1);
            }
            //printf("- compression buffer allocated\n");

            u64 remaining = total_uncompressed_size;
            u8 *read_ptr = all_data;
            u32 current_chunk = 0;
            ...
            while(remaining > 0) {
                ...
                int compressed_size = oodle_compress(read_ptr, to_compress, compressed_buffer);
                if(compressed_size < 0) {
                    printf("\nError: Oodle compression failed at chunk %u\n", current_chunk);
                    exit(1);
                }

                if(current_chunk < 5) {
                    printf("  Chunk %u: %u -> %u bytes (%.1f%%)\n",
                           current_chunk, to_compress, compressed_size,
                           100.0 * compressed_size / to_compress);
                }

                // Write compressed data (already includes 0x8c 0x00 header from OodleLZ_Compress)
                myfw(fdo, compressed_buffer, compressed_size);
                current_chunk++;
            ...
            // Update offset table
            u64 end_pos = ftell(fdo);
            fseek(fdo, chunk_table_pos, SEEK_SET);
            for(i = 0; i <= chunk_count; i++) {
                fputxx(fdo, chunk_offsets[i], 8);
            }
            fseek(fdo, end_pos, SEEK_SET);
            free(chunk_offsets);

            printf("- compression complete: %u bytes -> %u bytes (%.1f%%)\n",
                   (u32)total_uncompressed_size, (u32)end_pos,
                   100.0 * end_pos / total_uncompressed_size);

        } else {
            // Original NCTT (no compression) path
            ...
            // Write file data for NCTT
            printf("- writing %d files...\n", tot);
            for(i = 0; i < tot; i++) {
                if((i % 100) == 0) printf("  writing file %d...\n", i);
                ttarch_import(fdo, files[i].name, NULL);
            }
        }
    } else {
    ...
    // Skip writing file data if we already compressed it in the zCTT path
    if(!(ext && !stricmp(ext, ".ttarch2") && use_oodle)) {
        size_check = 0;
        for(i = 0; i < tot; i++) {
            size_check += ttarch_import(fdo, files[i].name, NULL);
        }
...
int ttarch_extract(FILE *fd, u8 *input_fname) {
    ...
    if(islower(version & 0xff)) {   // eCTT and zCTT
        switch(fgetxx(fd, 4)) {      // 1
            case 0: /* zlib? */                         break;
            case 1: do_decompress = _oodle_decompress;  break;
            default: /* ??? */                          break;
        }
        version = (version & 0xffffff00) | toupper((version & 0xff));
    }
...
//goto_tt_mode:   // The Wolf Among Us: NCTT / ZCTT / 3ATT
    ...
    if(verbose) {
        ...
        printf("  names_offset  %08x\n", (int)names_offset);
        printf("  base_offset   %08x\n", (int)base_offset);
    }
    ...
    // BUG FIX #5: First pass through file table to find total uncompressed size,
    // then derive last chunk's exact decompressed size.
    if(ttarch_tot_idx > 0) {
        u8  *saved_t = t;
        u64 max_end  = 0;
        for(u32 fi = 0; fi < files; fi++) {
            ttarch_getxx(NULL, &t, 8);  // hash
            u64 foff = ttarch_getxx(NULL, &t, 8) + base_offset;
            u64 fsz  = ttarch_getxx(NULL, &t, 4);
            ttarch_getxx(NULL, &t, 4);  // dummy
            ttarch_getxx(NULL, &t, 2);  // name_blk
            ttarch_getxx(NULL, &t, 2);  // name_off
            u64 fend = foff + fsz;
            if(fend > max_end) max_end = fend;
        }
        t = saved_t;
        if(max_end > 0) {
            ttarch_last_chunk_sz = max_end - (u64)(ttarch_tot_idx - 1) * ttarch_chunksz;
            printf("- last chunk decompressed size: %u bytes (total=%u, chunks=%u, chunk_size=%u)\n",
                   (u32)ttarch_last_chunk_sz, (u32)max_end, ttarch_tot_idx, ttarch_chunksz);
        }
    }
...
goto_classic_mode:
    ...
    if(version >= 3) {
        ...
        if(version >= 4) {
            ...
            if(version >= 7) {
                ...
                if(version >= 8) {
                    fgetxx(fd, 1);  // 0 or 1
                    if(version >= 9) {  // sort of CRC, apparently for version 9 only
                        if(files_mode >= 2) fgetxx(fd, 4);
                    }
                }
            }
        }
    ...
    info_size  = fgetxx(fd, 4);
    if(!info_size) info_size  = fgetxx(fd, 4);  // this is a lame work-around for some old version 8 archives that can be ignored and removed
...
goto_extract:
    ...
    if((version >= 7) && (files_mode >= 2)) {
        ...
        do_decompress(t, info_zsize, info_table, info_size);
        FREE(t)
    } else {
    ...
    // BUG FIX #5: Calculate last chunk's exact decompressed size
    // First pass through file table to find total uncompressed data size,
    // then derive last chunk size: total - (chunk_count-1) * chunk_size
    if(ttarch_tot_idx > 0) {
        u8  *saved_t = t;
        u64 max_end  = 0;
        u32 nfiles   = (u32)ttarch_getxx(NULL, &t, 4);
        for(u32 fi = 0; fi < nfiles; fi++) {
            ttarch_getname(NULL, &t);
            ttarch_getxx(NULL, &t, 4);  // zero
            u64 foff = ttarch_getxx(NULL, &t, 4);
            u64 fsz  = ttarch_getxx(NULL, &t, 4);
            u64 fend = foff + fsz;
            if(fend > max_end) max_end = fend;
        }
        t = saved_t;  // reset pointer for second pass
        if(max_end > 0) {
            ttarch_last_chunk_sz = max_end - (u64)(ttarch_tot_idx - 1) * ttarch_chunksz;
            printf("- last chunk decompressed size: %u bytes (total=%u, chunks=%u, chunk_size=%u)\n",
                   (u32)ttarch_last_chunk_sz, (u32)max_end, ttarch_tot_idx, ttarch_chunksz);
...
u8 *ttarch_meta_dump(u8 *ext, u8 *data, u64 *datalen) { // completely experimental and horrible, ignores the classes
    ...
    if((file_type & 0xffffff00) == 0x4d535600) {   // 5VSM, 6VSM, *VSM
...
// imported from QuickBMS
#ifdef WIN32
#include "MemoryModule.c"
#define QUICKBMS_ERROR_DLL  1
#define myexit  exit
// oodle.c is now compiled separately, no need to include it here
// Declarations are in oodle.c, extern declarations are at the top of this file
#endif
...
i64 _oodle_decompress(u8 *in, i64 insz, u8 *out, i64 outsz) {
    ...
    if(insz >= 2 && in[0] == 0x8c) {
        // BUG FIX #5: OodleLZ_Decompress returns 0 when outsz > actual decompressed size
        // (e.g., last chunk has < chunk_size bytes but we always pass chunk_size).
        // Use bIsSafe=0 to avoid strict output buffer size enforcement.
        ret = OodleLZ_Decompress(in, insz, out, outsz, 0, 0, 0, NULL, NULL, NULL, NULL, NULL, NULL, 3);
        if(ret == 0) {
            // Fallback to bIsSafe=1 (original parameters)
            ret = OodleLZ_Decompress(in, insz, out, outsz, 1, 0, 1, NULL, 0, NULL, NULL, NULL, 0, 0);
        }
    } else {
        ret = oodle_decompress(in, (int)insz, out, (int)outsz, "LZHLW");
    }
#endif
    if(!ret) {
